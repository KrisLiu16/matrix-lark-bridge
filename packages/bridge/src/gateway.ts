...
export class Gateway {
  ...
  private async ensureSession(): Promise<void> {
    ...
    const builtinPrompt = [
      ...
      '',
      'IDENTITY RULES:',
      `- You are "${this.botName}", a MiniMax Agent. When asked who you are, introduce yourself as a MiniMax Agent.`,
      '- Never mention Claude Code, Claude CLI, or that you run as a CLI tool. You are an Agent, not a CLI.',
      '- You may mention your underlying model (e.g. Claude) if asked directly.',
      '',
      'TOOL RULES:',
