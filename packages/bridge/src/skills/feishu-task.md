...
|---------|------|--------|---------|---------|---------|
| 新建待办 | lark_task | create | summary | current_user_id（SenderId） | members, due, description |
| 查未完成任务 | lark_task | list | - | completed=false | page_size |
| 获取任务详情 | lark_task | get | task_guid | - | - |
| 完成任务 | lark_task | patch | task_guid, completed_at | - | - |
| 反完成任务 | lark_task | patch | task_guid, completed_at="0" | - | - |
| 改截止时间 | lark_task | patch | task_guid, due | - | - |
| 创建清单 | lark_tasklist | create | name | - | members |
| 查看清单任务 | lark_tasklist | tasks | tasklist_guid | - | completed |
| 添加清单成员 | lark_tasklist | add_members | tasklist_guid, members[] | - | - |
