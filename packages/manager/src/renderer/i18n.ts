...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'claude.setup.step.download': '下载 Claude Code',
    'claude.setup.step.install_path': '安装到 MLB 专属目录',
  ...
  en: {
    ...
    'claude.setup.step.download': 'Download Claude Code',
    'claude.setup.step.install_path': 'Install to MLB directory',
