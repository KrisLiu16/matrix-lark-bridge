...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'claude.setup.step.homebrew': '检查 / 安装 Homebrew',
    'claude.setup.step.ffmpeg': '检查 / 安装 FFmpeg',
    ...
    'files.back': '返回',
    'files.refresh': '刷新',
    'files.reveal': '在 Finder 中打开',
    'files.empty': '目录为空',
    'files.notFound': '工作目录不存在',
    'files.preview': '预览',
    'files.preview.truncated': '文件过大，仅显示前 {size}',
    'files.preview.binary': '二进制文件，无法预览',
    'files.action.files': '文件',
    // Common
    'common.loading': '加载中...',
    'common.error': '出错了',
    'common.language': '语言',
  ...
  en: {
    ...
    'claude.setup.step.homebrew': 'Check / Install Homebrew',
    'claude.setup.step.ffmpeg': 'Check / Install FFmpeg',
    ...
    'files.notFound': 'Work directory does not exist',
    'files.preview': 'Preview',
    'files.preview.truncated': 'File too large, showing first {size}',
    'files.preview.binary': 'Binary file, cannot preview',
