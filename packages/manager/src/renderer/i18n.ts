...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'config.claude.model': '模型 (可选)',
    'config.claude.model.placeholder': '(默认)',
    ...
    'claude.setup.step.download': '下载并安装 Claude Code',
    'claude.setup.step.install_path': '配置 PATH 环境变量',
    'claude.setup.step.config_dir': '创建配置目录',
    'claude.setup.step.config_endpoint': '配置 API 端点',
    'claude.setup.step.config_env': '写入环境配置',
  ...
  en: {
    ...
    'config.claude.model': 'Model (optional)',
    'config.claude.model.placeholder': '(default)',
    ...
    'claude.setup.step.download': 'Download & install Claude Code',
    'claude.setup.step.install_path': 'Configure PATH',
    'claude.setup.step.config_dir': 'Create config directory',
    'claude.setup.step.config_endpoint': 'Configure API endpoint',
    'claude.setup.step.config_env': 'Write environment config',
