...
|---------|------|--------|---------|---------|---------|
| 创建会议 | lark_calendar_event | create | summary, start_time, end_time | user_open_id | attendees, description, location |
| 查某时间段日程 | lark_calendar_event | list | start_time, end_time | - | - |
| 改日程时间 | lark_calendar_event | patch | event_id, start_time/end_time | - | summary, description |
| 搜关键词找会 | lark_calendar_event | search | query | - | - |
| 回复邀请 | lark_calendar_event | reply | event_id, rsvp_status | - | - |
| 查重复日程实例 | lark_calendar_event | instances | event_id, start_time, end_time | - | - |
| 查忙闲 | lark_calendar_freebusy | list | time_min, time_max, user_ids[] | - | - |
| 邀请参会人 | lark_calendar_event (with attendees parameter) | create | calendar_id, event_id, attendees[] | - | - |
| 删除参会人 | lark_calendar_event (with attendees parameter) | batch_delete | calendar_id, event_id, user_open_ids[] | - | - |
...
**查询预约结果**：使用 `lark_calendar_event (with attendees parameter).list` 查看 `rsvp_status`。
